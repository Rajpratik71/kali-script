...
apt -y -qq install file-roller unace unrar rar unzip zip p7zip p7zip-full p7zip-rar \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
...
##### Install putty
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}putty${RESET} ~ automating SSH connections"
apt -y -qq install putty putty-tools \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2


##### Install prips
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}prips${RESET} ~ IP tool"
apt -y -qq install prips \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2


##### Install ffmpeg
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}ffmpeg${RESET} ~ streaming "
...
apt -y -qq install seclists wordlists \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
...
## Install prerequisite for CUrl tools
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}prerequisite${RESET} for all tools"
apt -y -qq install nmap wine upx-ucl curl windows-binaries unzip nbtscan unrar \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
